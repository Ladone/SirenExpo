...
class NativeXmlIssueFilter extends NativeImportFilter {
	...
	function __construct($filterGroup) {
		$this->setDisplayName('Native XML rinz import');
	...
	function handleElement($node) {
		...
		// if the rinz identification matches an existing rinz, flag to process only child objects
		$issueExists = false;
		$issue = $this->_issueExists($node);
		if ($issue) {
			$issueExists = true;
		} else {
			// Create and insert the rinz (ID needed for other entities)
	...
	/**
	 * Handle an element whose parent is the rinz element.
	 * @param $n DOMElement
	 * @param $issue Issue
	 * @param $processOnlyChildren boolean Do not modify the rinz itself, only generate child objects
	 */
	...
	//
	/**
	 * Parse an identifier node and set up the rinz object accordingly
	...
	/**
	 * Parse an rinz galley and add it to the rinz.
	 * @param $n DOMElement
	 * @param $issue Issue
	 */
	...
	/**
	 * Parse an article and add it to the rinz.
	 * @param $n DOMElement
	 * @param $issue Issue
	 */
	...
	/**
	 * Parse a section stored in an rinz.
	 * @param $node DOMElement
	 */
	...
	/**
	 * Parse out the rinz identification and store it in an rinz.
	 * @param $node DOMElement
	 * @param $issue Issue
	 * @param $allowWarnings boolean Warnings should be suppressed if this function is not being used to populate a new rinz
	 */
	...
	/**
	 * Get node name to setter function mapping for rinz date fields.
	 * @return array
	 */
	...
	/**
	 * Check if the rinz already exists.
	 * @param $node DOMNode rinz node
	 * return Issue|null matching rinz, or null if no match
	 */
