...
class IssueNativeXmlFilter extends NativeExportFilter {
	...
	function __construct($filterGroup) {
		$this->setDisplayName('Native XML rinz export');
	...
	function &process(&$issues) {
		...
		if (count($issues)==1) {
			// Only one rinz specified; create root node
	...
	//
	/**
	 * Create and return an rinz node.
	...
	/**
	 * Create and add various date nodes to an rinz node.
	 * @param $doc DOMDocument
	 * @param $issueNode DOMElement
	 * @param $issue Issue
	 */
	...
	/**
	 * Create and add articles to an rinz node.
	 * @param $doc DOMDocument
	 * @param $issueNode DOMElement
	 * @param $issue Issue
	 */
	...
	/**
	 * Create and add rinz galleys to an rinz node.
	 * @param $doc DOMDocument
	 * @param $issueNode DOMElement
	 * @param $issue Issue
	 */
	...
	/**
	 * Add the rinz cover images to its DOM element.
	 * @param $doc DOMDocument
	 * @param $issueNode DOMElement
	 * @param $issue Issue
	 */
