...
class NativeXmlArticleFilter extends NativeXmlSubmissionFilter {
	...
	/**
	 * Populate the submission object from the node, checking first for a valid section and published_date/rinz relationship
	...
	function populateObject($submission, $node) {
		...
		// check if article is related to an rinz, but has no published date
	...
	/**
	 * Get the rinz from the given identification.
	 * @param $node DOMElement
	 * @return Issue
	 */
