...
/**
 * @file plugins/importexport/native/SirenExpoImportExportDeployment.inc.php
 *
...
class SirenExpoImportExportDeployment extends PKPNativeImportExportDeployment {
