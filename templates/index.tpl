 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.sirenexpo.displayName"}
...
<div id="exportIssues-tab">
	...
	<form id="exportIssuesXmlForm" class="pkp_form" action="{plugin_url path="exportIssues"}" method="post">
        ...
        {fbvFormButtons submitText="plugins.importexport.sirenexpo.exportIssues" hideCancel="true"}
        {/fbvFormArea}
	</form>
</div>
<pre>
